...
public class MainLayout extends AppLayout {
        ...
        private void createDrawer() {
                ...
                if (securityService.getAuthenticatedUsername() != null) {
                        username = securityService.getAuthenticatedUsername(); // Works with Jwt
                }
                System.out.println(securityService.getAuthenticatedUsername());
